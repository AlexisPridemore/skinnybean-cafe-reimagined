            ...
            >
              ...
              <div className="flex h-28 items-center justify-center py-2 sm:h-32">
                <img
                  ...
                  alt={h.imageAlt}
                  loading="lazy"
                  className={`max-h-full max-w-full object-contain ${h.title === "The Not So Skinny Burrito" ? "w-[9.5rem]" : h.title === "Breakfast Nachos" ? "w-[9rem]" : h.title === "Espresso Brownie Shake" ? "w-[7.5rem] scale-110" : "w-[6rem]"}`}
                />
              </div>
